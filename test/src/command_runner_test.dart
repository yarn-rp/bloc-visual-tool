...
import 'package:visual_bloc/src/command_runner.dart';
...
void main() {
  group('VisualBlocCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late VisualBlocCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = VisualBlocCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = VisualBlocCommandRunner();
